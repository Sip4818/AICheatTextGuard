...
valid_text = "This is a sufficiently long text that needs to be at least two hundred and fifty characters long to pass the pydantic validation in the predict request. " * 3
