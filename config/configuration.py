...
from src.utils.common import read_yaml, create_dir, write_yaml, is_yaml_content_empty
...
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            create_dir(
                self.model_evaluation_cfg.root_dir, "Model evalutaion root artifact"
            )
            ...
            return ModelEvaluationConfig(
                ...
                plot_file_path=self.model_evaluation_cfg.plot_file_path,
